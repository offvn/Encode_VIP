...
def main():
    ...
    obfuscated_stub = f"""__author__ = 'HDT_TOOL'
__madeBy__ = ' https://t.me/botspamcallsms '
__git__ = 'https://t.me/botspamcallsms'

# https://t.me/botspamcallsms
...
try:
    ...
    __import__('os').system('xdg-open https://t.me/botspamcallsms')
