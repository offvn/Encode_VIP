...
recode_kontol = %s;HDT_TOOL=(eval((lambda ____,__,_ : ____.join([_(___) for ___ in __]))('',[95, 95, 105, 109, 112, 111, 114, 116, 95, 95, 40, 39, 109, 97, 114, 115, 104, 97, 108, 39, 41, 46, 108, 111, 97, 100, 115],chr))(recode_kontol));exec(HDT_TOOL)

Hidekii_ = (\n'''

        denventa_lines = [f'"000000000000000","000000000000000","000000000000000","000000000000000","000000000000000", {str(["import", "as", "from", "marshal", "zlib", "base64"])}, "Ryougaa_Hidekii__=(eval((lambda", "exec(", ";exec(HDT_TOOL)"' for _ in range(140, 1409)]
